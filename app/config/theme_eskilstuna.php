...
return [
    ...
    ['region' => 'footer', 'template' => 'eskilstuna/footer', 'data' => [], 'sort' => -1],
    ...
    'data' => [
        ...
        'title_append' => ' | Allt om Eskilstuna',

        // Stylesheets
        'stylesheets' => ['css/style.css', 'css/navbar.css', 'css/comments.css'],
