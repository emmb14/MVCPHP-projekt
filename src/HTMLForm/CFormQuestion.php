...
/**
* Anax base class for question forms.
*
*/
class CFormQuestion extends \Mos\HTMLForm\CForm
{
	...
	public function __construct($questions, $userId, $tags, $question=null)
	{
		...
		parent::__construct([], [
			...
			'tags' => [
				'type'        => 'text',
				'label'       => 'Taggar: (separera taggarna med kommatecken (,) och utan mellanrum)',
				'required'    => true,
				'validation'  => ['not_empty'],
	...
	*/
	public function callbackSubmit()
	{
		...
		$this->questions->save([
			'userId' => $this->userId,
			'question' => $this->Value('text'),//$text,//$this->textFilter->doFilter($this->Value('text'), 'shortcode, markdown'),
	...
	{	
		...
		//$this->AddOutput("<p><i>Kontot är nu skapat. Du kan nu logga in med uppgifterna du angav.</i></p>");
		//$this->redirectTo();
	}
